shared_examples "paginatable concern" do |factory_name|
  context "when records fits page size" do
    ...
    context "when :page fulfilled and :length is empty" do
      let(:page) { 2 }
    ...
    context "when :page and :length are fufilled and fits records size" do
      let(:page) { 2 }
      let(:length) { 5 }
    ...
    context "when :page and :length are fufilled and doed not fit records size" do
      let(:page) { 2 }
      let(:length) { 30 }
